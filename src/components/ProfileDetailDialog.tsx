...
type ProfileEditorSection = 'contacts' | 'family' | 'feeding'

export function ProfileDetailDialog({ section, focus, onClose, onEdit }: { section: ProfileSection; focus?: string | null; onClose: () => void; onEdit: (section: ProfileEditorSection) => void }) {
