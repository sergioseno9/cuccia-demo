import { AlertCircle, Check, ExternalLink, FileText, HeartPulse, Pill, Plus, Scale, Scissors, Shield, ShieldCheck, Stethoscope, Syringe } from 'lucide-react'
...
const sectionTitles: Record<CareSection, string> = {
  ...
  prevention: 'Antiparassitari',
  deworming: 'Sverminazione',
  medication: 'Farmaci e terapie',
  visit: 'Visite veterinarie',
  weight: 'Peso e crescita',
  grooming: 'Igiene e abitudini',
  documents: 'Documenti',
...
function PreventionSection({ explanation, records, title, onAdd }: { explanation: string; records: PreventionRecord[]; title: string; onAdd: () => void }) {
...
export function CareDetailDialog({ section, onAdd, onClose, onEditProfile }: { section: CareSection; onAdd: (type: HealthRecordType) => void; onClose: () => void; onEditProfile: () => void }) {
